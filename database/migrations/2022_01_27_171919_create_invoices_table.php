...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            $table->id();
            $table->integer('invoice_type');  //group or single
            ...
            $table->integer('type')->default(1);   //نقدي او اجل
            $table->integer('invoice_status')->default(1); // حالة الفاتورة هل هي كشف ام مراجعة
            $table->timestamps();
        });
    }
