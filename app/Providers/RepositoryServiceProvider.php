...
use App\Repository\Dashboard_Patient\Patient_DetailsRepository;
...
use App\Repository\PTEmployee\PTEmployeeRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(PTEmployeeRepositoryInterface::class, PTEmployeeRepository::class);
        ...
        $this->app->bind('App\Interfaces\Dashboard_Laboratorie_Employee\HaematologiesRepositoryInterface',
            'App\Repository\Dashboard_Laboratorie_Employee\HaematologiesRepository');


        //Dashboard_Patient

        $this->app->bind(Patient_DetailsRepositoryInterface::class, Patient_DetailsRepository::class);
