    ...
    <table class="table text-md-nowrap" id="example1" data-page-length="50"style="text-align: center">
        ...
        @foreach ($group_invoices as $group_invoice)
            <tr>
                ...
                <td>{{ $group_invoice->Group->name }}</td> {{--Group is the relation name--}}
                ...
                <td>
                    ...
                    <a href="#"  wire:click="print({{ $group_invoice->id }})" class="btn btn-warning btn-sm" target="_blank" title="طباعه فاتورة مجمعة "><i class="fas fa-print"></i></a>
                    {{-- <button wire:click="print({{ $group_invoice->id }})" class="btn btn-warning btn-sm" ><i class="fas fa-print"></i></button> --}}
                </td>
            </tr>
