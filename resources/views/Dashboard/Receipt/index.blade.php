                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Receipt.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">اضافة سند قبض جديد</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                           ...
                                           @foreach($receipts as $receipt)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a href="{{route('Receipt.show',$receipt->id)}}" class="btn btn-warning btn-sm" target="_blank" title="طباعه سند قبض"><i class="fas fa-print"></i></a>
                                                   </td>
                                               </tr>
