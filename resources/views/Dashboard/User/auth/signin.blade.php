                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionChooser">
                                                    ...
                                                    <option value="pt_employee">موظف علاج طبيعي</option>
                                                </select>
                                            </div>
                                            ...
                                            {{--form PT_employee--}}
                                            <div class="panel" id="pt_employee">
                                                <h2>الدخول موظف علاج طبيعي</h2>
                                                <form method="POST" action="{{ route('login.pt_employee') }}">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label>Email</label> <input  class="form-control" placeholder="Enter your email" type="email" name="email" :value="old('email')" required autofocus>
                                                    </div>
