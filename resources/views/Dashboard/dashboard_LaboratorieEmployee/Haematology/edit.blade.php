        ...
        <div class="card">
            <div class="card-body">
                <form action="#" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="invoice_id" value="{{$haema->invoice_id}}">
                    <input type="hidden" name="patient_id" value="{{$haema->patient_id}}">
                    <input type="hidden" name="doctor_id" value="{{$haema->doctor_id}}">

                    <div class="row">
                        <div class="col-3">
                            <label>  المريض/   {{$haema->Patient->name}} </label>
                        </div>
                    <label>  الطبيب/   {{$haema->doctor->name}} </label>
                    ...
                    <div class="row">
                        <div class="col-1">
                            <label>HGB </label>
                            <input type="text" name="HGB"   class="form-control" value="{{$haema->HGB}}" >
                        </div>

                        <div class="col-2">
                            <label> HGB Normal Range</label>
                            <select  class="form-control" name="n_HGB" >
                                <option value="100" {{$haema->n_HGB == 100 ? 'selected':''}}> 100 </option>
                                <option value="200" {{$haema->n_HGB == 200 ? 'selected':''}}> 200 </option>
                            </select>
                        </div>
                        ...
                        <div class="col-1">
                            <label>HCT </label>
                            <input type="text" name="HCT"   class="form-control" value="{{$haema->HCT}}" >
                        </div>
                        <div class="col-2">
                            <label> HCT Normal Range</label>
{{--                            <select  class="form-control" name="n_HCT" >--}}
{{--                                <option value="100" {{$haema->n_HCT == 100 ? 'selected':''}}> 100 </option>--}}
{{--                                <option value="200" {{$haema->n_HCT == 100 ? 'selected':''}}> 200 </option>--}}
{{--                            </select>--}}

                            <select  class="form-control" name="n_HCT" >
                                <option value="100" {{$haema->n_HCT == 100 ? 'selected':''}}> 100 </option>
                                <option value="200" {{$haema->n_HCT == 200 ? 'selected':''}}> 200 </option>
                            </select>
                        ...
                        <div class="col-1">
                            <label>RBCs </label>
                            <input type="text" name="RBCs"   class="form-control" value="{{$haema->RBCs}}">
                        </div>
                        <div class="col-2">
                            <label> RBCs Normal Range</label>
{{--                            <select  class="form-control" name="n_RBCs" >--}}
{{--                                <option value="100"{{$haema->n_RBCs == 100 ? 'selected':''}} >100</option>--}}
{{--                                <option value="200" {{$haema->n_RBCs == 100 ? 'selected':''}} >200</option>--}}
{{--                            </select>--}}

                            <select  class="form-control" name="n_RBCs" >
                                <option value="100" {{$haema->n_RBCs == 100 ? 'selected':''}}> 100 </option>
                                <option value="200" {{$haema->n_RBCs == 200 ? 'selected':''}}> 200 </option>
                            </select>
                        </div>
                    </div>
