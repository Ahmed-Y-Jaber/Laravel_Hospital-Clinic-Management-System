                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                        <tr>
                                                            ...
                                                            {{-- <td>{{$patient_ray->employee_id !==null ? $patient_ray->employee->name:'NOEmployee'}}</td>  (if else)--}}
                                                            {{-- <td>{{$patient_ray->employee->name ?? 'noEmployee'}}</td>  (?? = or)--}}
                                                            ...
                                                            @if($patient_ray->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning " href="{{route('docinvoices.show',$patient_ray->id)}}"  ><i class="fas fa-binoculars"></i></a>
                                                                    </td>
                                                                @endif
