            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Doctors.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        {{-- enctype="multipart/form-data عشان يعرف انه في مرفقات حتترفع معايا --}}
                        {{ csrf_field() }}
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">  {{--[]  عشان انه حياخد عدة مواعيد--}}
...
@section('js')
    ...
    <script>
        var loadFile = function(event) {
            var output = document.getElementById('output'); // output هي id  الصورة
