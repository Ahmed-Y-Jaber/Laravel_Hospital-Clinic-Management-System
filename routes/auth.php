...
use App\Http\Controllers\Auth\PTEmployeeController;
...
Route::post('/login/pt_employee', [PTEmployeeController::class, 'store'])->middleware('guest')->name('login.pt_employee');

Route::post('/logout/pt_employee', [PTEmployeeController::class, 'destroy'])->middleware('auth:pt_employee')->name('logout.pt_employee');
