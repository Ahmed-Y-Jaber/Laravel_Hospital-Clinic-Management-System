...
use App\Http\Controllers\Dashboard\PTEmployeeController;
...
})->middleware(['auth:admin'])->name('dashboard.admin'); // auth:admin the gard name for admin
...
Route::get('/dashboard/doctor', function () {
 ...
 Route::middleware(['auth:admin'])->group(function () {
    ...
    //############################# end GroupServices route ######################################
     ...
     Route::resource('pt_employee', PTEmployeeController::class);

     //############################# end PT Employee route ######################################
     ...
     Route::get('appointments/certain',[appointmentController::class,'index2'])->name('appointments.index2');
